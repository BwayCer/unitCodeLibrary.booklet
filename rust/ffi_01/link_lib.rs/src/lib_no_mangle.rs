...
#[no_mangle]
pub extern "C" fn base_func() {
    print_message::print_base_func_by_send_response("no-mangle");
}

#[no_mangle]
pub extern "C" fn pure_data(argu1: bool, argu2: i8, argu3: PureDataArgs) -> PureDataResult {
